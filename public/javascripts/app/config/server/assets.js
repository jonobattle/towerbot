(function() {
  ...
  module.exports = {
    javascripts: {
      application: ['/app/config/shared/application', '/app/config/client/bootstrap', '/app/config/client/watch', '/app/config/shared/routes', '/app/controllers/client/applicationController', '/templates', '/app/views/client/layout/application', '/app/models/shared/ircBot'],
      lib: [],
      ...
      development: ['/vendor/javascripts/mocha', '/vendor/javascripts/chai', '/test/client', '/test/cases/models/shared/ircBotTest']
    },
    stylesheets: {
